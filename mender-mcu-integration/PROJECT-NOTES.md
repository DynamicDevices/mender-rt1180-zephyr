...
Public repo: https://github.com/DynamicDevices/zephyr-rt1170-eink (stable `LANE_ID` in `LANE.id`: **zephyr-rt1170-eink**; peer **cloud-eink**). Covers **RT1170** Active ESL e-ink host work and the **RT118x** Mender overlay (EVK + FRDM CM33).
