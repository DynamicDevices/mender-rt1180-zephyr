# Document control — moved

Active-ESL **hardware specifications** are no longer controlled in this
firmware tree.

**Canonical repo:** [`active-esl/specifications`](https://github.com/active-esl/specifications)

| Document | Location |
|----------|----------|
| Document control | [DOCUMENT-CONTROL.md](https://github.com/active-esl/specifications/blob/main/DOCUMENT-CONTROL.md) |
| `AESL-HW-RT1170-EINK-SPEC` | [hw/AESL-HW-RT1170-EINK-SPEC/](https://github.com/active-esl/specifications/tree/main/hw/AESL-HW-RT1170-EINK-SPEC) |
| Google Doc mirror (Rev 0.2) | [docs.google.com/…](https://docs.google.com/document/d/1sBGqswNXyjKmipahd7Ip8u-baEguvz7c-nJcgpPSnJo/edit) |

Local clone on this machine: [`/data_drive/esl/specifications`](file:///data_drive/esl/specifications)

Firmware-local notes that remain here:
