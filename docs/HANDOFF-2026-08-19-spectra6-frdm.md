...
**Branch:** `feat/frdm-imxrt1186-el133` (uncommitted)  
...
- **Build:** `./scripts/build-rt1186-frdm-eink.sh` linked. Overlay `frdm_imxrt1186_mimxrt1186_cm33_eink_el133.{overlay,conf}`. e-tabelone **HTTP off** on this image; Mender client **on**; net-buffer shrink **removed** after RAM fix.
